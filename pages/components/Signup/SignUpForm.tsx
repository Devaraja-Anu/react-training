  ...
  return (
    <div>
        <div className='flex justify-center md:py-24'>
              <div className='h-screen flex flex-col s justify-center bg-[#FAFFFD]'>
            ...
            <form className=' border-2 rounded-xl  border-black border-opacity-5 px-4 my-16 lg:px-8 h-auto mx-5 lg:m-14  xl:m-20 sm:w-4/5 sm:h-auto' action="post">
              ...
              <button className='border-0 mx-0 m-4 text-white rounded-xl h-12 bg-[#00C285] font-base w-full' type="submit">Submit</button>
                  ...
                  <div className='xl:border h-0 xl:w-7 border-black bg-black mx-2 '></div>
                  <div className='flex  flex-col'>
                   <p className='pr-2 font-base text-sm sm:text-base'>Already have an Account? </p>
                   <span className='text-[#00C285] font-base text-sm sm:text-base'><Link href={"login"}>Login</Link></span>
                  </div>
                   <div className='xl:border h-0 xl:w-7 border-black bg-black mx-2'></div>
                  </div>  
              </form>
