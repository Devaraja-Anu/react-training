    ...
    <div className="mt-20">
        <div className={`${props.background} mx-10 md:mx-20 rounded-3xl m-20"`}>
            <div className="flex place-content-between">
                <div className="flex flex-col justify-center pl-10 md:pl-20">
                    <h1 className="font-base text-white text-2xl md:text-3xl lg:text-4xl xl:text-6xl font-bold">{props.heading}</h1>
                    <p className="font-base text-white pt-8 xl:pt-10 md:text-xl  lg:text-3xl">{props.bottomtext}</p>
                </div>

                <div className="p-10">
                <Image className="object-contain" src={props.image} alt='Corpo art'/>
                </div>
            </div>
        </div>
    </div>
